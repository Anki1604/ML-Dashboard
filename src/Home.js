...
class JsonForm extends Component{
    constructor(props){
    super(props);
    this.state={Gender:"Male", Married:"No", Dependents:0, Education:"Graduate", Self_Employed:"No", ApplicantIncome:5489, CoapplicantIncome:0, LoanAmount:128, Loan_Amount_Term:360, Credit_History:1, Property_Area:"Urban", score:1};
